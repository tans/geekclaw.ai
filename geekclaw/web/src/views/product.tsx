      ...
      <script dangerouslySetInnerHTML={{ __html: `
        ...
        async function createOrder(productId, shippingName, shippingPhone, shippingAddress) {
          ...
          try {
            ...
            if (data.payUrl) {
              qrLoading.classList.add('hidden');
              qrContainer.insertAdjacentHTML('beforebegin', '<div class="mb-4"><p class="text-sm text-[color:var(--color-ink-soft)] mb-4">点击下方按钮跳转到支付宝电脑网站支付页面</p><a href="' + data.payUrl + '" target="_blank" rel="noopener noreferrer" class="btn btn-primary btn-lg">前往支付</a></div>');
            }
