    ...
    <section class="marketing-section py-20 sm:py-24">
      <div class="marketing-section-inner space-y-6">
        <div class="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          ...
          <a
            href="/orders"
            class="inline-flex items-center justify-center rounded-full border border-[color:var(--line-soft)] bg-white px-5 py-3 text-sm font-medium text-[color:var(--ink-strong)] transition-colors hover:border-[color:var(--color-accent)] hover:text-[color:var(--color-accent)]"
          >
            我的订单
          </a>
        </div>
