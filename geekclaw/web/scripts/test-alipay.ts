 ...
 * 2. Simulate order submission and get desktop website payment URL
...
async function runOrderSimulation() {
  ...
  console.log("\n\x1b[36m[Test 1] Query Order Status\x1b[0m");
  try {
    const statusResult = await queryOrderStatus(`${testOrderNo}-page`);
  ...
  // Test 2: Simulate page pay order (alipay.trade.page.pay)
  console.log("\n\x1b[36m[Test 2] Page Pay Order (alipay.trade.page.pay)\x1b[0m");
  try {
  ...
  console.log("1. Page Pay: Open the payUrl in browser\n");
}
