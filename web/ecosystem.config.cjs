  ...
  apps: [
    {
      ...
      env: {
        ...
        THEME_COLOR: "#b42318",
        OEM_BRAND_NAME: "GeekClaw",
        OEM_SITE_NAME: "GeekClaw",
        OEM_BRAND_URL: "https://geekclaw.ai",
        OEM_BRAND_LOGO_URL: "/public/geekclaw.png",
        OEM_SEO_TITLE: "GeekClaw",
        OEM_SEO_DESCRIPTION:
          "GeekClaw 帮助企业完成 AI 能力的部署、接入、治理与长期运行，提供后台管理、电商与支付能力。",
        OEM_SEO_KEYWORDS:
          "GeekClaw,企业AI,私有化部署,本地部署,智能体,电商,后台管理",
